...
import com.seguranca_urbana.backend.services.user.admin.AdminUpdateOccurrenceStatusService;
...
class AdminUpdateOccurrenceStatusServiceTest {
    ...
    @InjectMocks
    private AdminUpdateOccurrenceStatusService service;
